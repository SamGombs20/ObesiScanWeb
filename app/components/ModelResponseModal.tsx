...
export const ResponseModal: FC<Props> = ({
  prediction,
  recommendation,
  close,
}) => {
  return (
    <div className={style.response_container}>
      <div className={style.title_container}>
        ...
        />
        <p className={`${style.title_text} gradient-text`}>
          Prediction Results
        </p>
      </div>
        ...
        <div className={style.main_content_container}>
          <div className={style.content_container}>
            ...
            <p className={style.content}>
              The model predicts your obesity level to be{" "}
      ...
      <div className={style.form_buttons}>
        <button className={`${style.close_btn} btn`} onClick={close}>
          Close
        </button>
      </div>
    </div>
